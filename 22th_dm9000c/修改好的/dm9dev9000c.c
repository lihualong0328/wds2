...
int __init dmfe_probe1(struct net_device *dev)
{
	...
	do {
		...
		if (id_val == DM9KS_ID || id_val == DM9010_ID) {
			...
			/* thisway.diy@163.com */	//版本不对，没关系，2440的确不是这样，加打印可知此处报错
...
int __init dm9000c_init(void)
{
	...
	iobase = (int)ioremap(0x20000000, 1024);	/* thisway.diy@163.com *///看代码中使用情况在映射
