...
static int s3c_nand_init(void)
{
	...
	/* 3. 硬件相关的设置: 根据 NAND 的手册设置时间参数 */
	/* 使能 NAND 控制器的时钟 *///kernel为了省电，上电后把用不到的模块都关闭
...
#define TWRPH1   0
	...
	nand_scan(s3c_mtd, 1);  /* 识别 NAND , 构造mtd_info */	//2th只是识别nand,没有add_mtd_partitions前,kernel里的nand对此没影响;
