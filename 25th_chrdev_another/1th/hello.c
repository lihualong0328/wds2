...
static int hello_init(void)
{
	...
	/* 3. 告诉内核 */
#if 0
	major = register_chrdev(0, "hello", &hello_fops); /* (major,  0), (major, 1), ..., (major, 255)都对应 hello_fops */
#else
	if (major) {
		devid = MKDEV(major, 0);	//minor从0开始
	...
	// class_device_create(cls, NULL, MKDEV(major, 2), NULL, "hello2"); /* /dev/hello2 */	//open(/dev/hello2)失败，(major, 2)没有找到对应的 fops
