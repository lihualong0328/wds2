...
/* 发出地址 */
static void s3c2440_write_addr(unsigned int addr)	// 小页
{
    int i;
	S3C2410_NAND * s3c2410nand = (S3C2410_NAND *)0x4e000000;
	S3C2440_NAND * s3c2440nand = (S3C2440_NAND *)0x4e000000;
...
static void write_addr(unsigned int addr)
{
    if ((GSTATUS1 == 0x32410000) || (GSTATUS1 == 0x32410002))
    {
	    s3c2410_write_addr(addr);   // 2410没实现lp写地址操作
    }
	else
	{
...
#if 0
//大小不是整页对齐，#ifdef LARGER_NAND_PAGE要去掉，i2c.bin的大小=(2bc0==11000); 11000 / 2048 != 0
